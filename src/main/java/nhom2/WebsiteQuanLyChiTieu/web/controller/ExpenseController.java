package nhom2.WebsiteQuanLyChiTieu.web.controller;

import nhom2.WebsiteQuanLyChiTieu.backend.model.Expense;
import nhom2.WebsiteQuanLyChiTieu.backend.model.ExpenseType;
import nhom2.WebsiteQuanLyChiTieu.backend.services.ExpenseService;
import nhom2.WebsiteQuanLyChiTieu.backend.services.ExpenseTypeService;
import nhom2.WebsiteQuanLyChiTieu.backend.exceptions.ExpenseTypeAlreadyExistsException;
import nhom2.WebsiteQuanLyChiTieu.web.helpers.Helpers;
...
public class ExpenseController {
    ...
    private static final int PAGE_SIZE = 20; //number of records per page
    ...
    public String showFilteredExpenses(@RequestParam(name = "year", required = false) Integer year,
        ...
        model.addAttribute("Chi phí", expenses);
        model.addAttribute("Tháng", monthToDisplay);
        model.addAttribute("Năm", yearToDisplay);
        model.addAttribute("Loại chi phí", expenseType);
    ...
    public ResponseEntity<Resource> downloadExpenses() {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment;filename=Chi tiêu.csv")
